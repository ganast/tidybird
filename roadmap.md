...
1. 5.0 Test thoroughly if everything works and release (without expert settings)
    ...
    1. Store release procedure
        1. Check code quality
            ...
            1. Commit & push changes, verify github action result
        1. Run last tests
            1. test basic functionality: moving
                ...
                1. test with special folders
                1. remove folder
                1. remove account
            1. test layout
                1. test with different themes (dark, system, light)
            ...
            1. test other options
                ...
                1. test cutoff
        1. Generate release
            1. Run web-ext build (serves only as test): `./node_modules/.bin/web-ext build --overwrite-dest`
